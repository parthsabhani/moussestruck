...
export const siteInfo = {
  ...
  hours: {
    ...
    note: "Mon – Sun, 11 AM to 4 PM"
  },
  orderNote: "Takeaway only · We'll reach out to confirm your order",
  orderHoursStart: 11,
  orderHoursEnd: 16,
};
...
export const products: Product[] = [
  ...
  },
  {
    ...
    description: "Madagascar vanilla mousse with caramelised white chocolate",
    price: "₹160",
    priceValue: 160,
...
export const testimonials: Testimonial[] = [
  {
    id: 1,
    name: "Sarah Johnson",
    review: "The chocolate mousse is absolutely divine! Best dessert I've ever had. The texture is so smooth and the flavour is incredibly rich.",
    rating: 5,
    date: "Nov 2024"
  },
  {
...
export const features = [
  ...
  },
  {
    ...
    description: "Order ahead and pick up fresh — no waiting around",
    icon: "truck"
  }
];
